...
// This is a JavaScript event. It means - once DOM is finished loading,
	...
	$(document).ready(function() {
	    ...
	    $.fn.extend({ fifteen:
	        ...
	        function(square_size) {
	            ...
	            // it is the selector - "#game_area" from  $("#game_area").fifteen(175);
	            var gameObjectElement = '#' + $(this).attr('id');
	 
	            var sqSize = square_size + 'px';
	            var boardSize = (square_size * 4) + 'px';
	 
	            // Inject DIV into game_area, this is our game board
    ...
    //     2. the width of the square
	    ...
	    // Create a game with 175 by 175 squares inside "#game_area" div:
	    $('#game_area').fifteen(100);
	});